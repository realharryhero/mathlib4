...
@[deprecated (since := "2023-12-23")] alias Nat.pow_lt_pow_of_lt_left := Nat.pow_lt_pow_left
@[deprecated (since := "2023-12-23")] alias Nat.pow_le_iff_le_left := Nat.pow_le_pow_iff_left
